...
print,'pztxdiff',pztxdiff
      nx=3
      if OBSvars.SJIok_rtype[0] then begin
        numcols = OBSvars.SJIec_rtype[0]-OBSvars.SJIsc_rtype[0]+1
        nx = numcols+pztxdiff
help,nx,numcols,pztxdiff
openw, lun, '~/data/iris/temp_test42.txt', /get_lun, /append
printf, lun, ''
printf, lun, 'new file  ', OBSvars.OBSid, '  ;  ' + filename
printf, lun, 'pztxdiff'+string(pztxdiff)
printf, lun, 'numcols '+string(numcols)
printf, lun, 'nx      '+string(nx)
printf, lun, 'OBSvars.PZTxmax     ', OBSvars.PZTxmax
printf, lun, 'OBSvars.PZTxmin     ', OBSvars.PZTxmin
printf, lun, 'OBSvars.cdelt1SJI   ', OBSvars.cdelt1SJI
printf, lun, 'OBSvars.SJIok_rtype ', OBSvars.SJIok_rtype
printf, lun, 'OBSvars.SJIsc_rtype ', OBSvars.SJIsc_rtype
printf, lun, 'OBSvars.SJIec_rtype ', OBSvars.SJIec_rtype
close, lun
free_lun, lun
;stop

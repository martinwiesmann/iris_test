...
level1dirs = '~/data/iris/SJI_Test_2/'
level1dirs = '~/data/iris/martin3/'

;outputfolders = '~/my_idl/syntoolDATA/L2/'
outputfolders = '~/data/iris/SJI_Test_2_l2/'
outputfolders = '~/data/iris/martin3_l2/'

;xmlparentfolder='/archive/iris/ops/tables/'
xmlparentfolder='~/data/iris/XML/'

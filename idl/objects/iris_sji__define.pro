...
;
; $Id: iris_sji__define.pro,v 1.88 2020/08/27 19:29:11 mawiesma Exp $
;
;-
...
; called by obj_destroy, frees all pointers and closes all associated files
  ...
  for i=0,self.nfiles-1 do begin
    ...
    ptr_free,self.sji_info[i].pc1_1
    ptr_free,self.sji_info[i].pc1_2
    ptr_free,self.sji_info[i].pc2_1
    ptr_free,self.sji_info[i].pc2_2
    ptr_free,self.sji_info[i].pc3_1
    ptr_free,self.sji_info[i].pc3_2
    ptr_free,self.sji_info[i].it01psji
    ptr_free,self.sji_info[i].it06tsji
    ptr_free,self.sji_info[i].it14ssji
    ptr_free,self.sji_info[i].it15ssji
    ptr_free,self.sji_info[i].it16ssji
    ptr_free,self.sji_info[i].it17ssji
    ptr_free,self.sji_info[i].it18ssji
    ptr_free,self.sji_info[i].it19ssji
    ptr_free,self.sji_info[i].poffxsji
    ptr_free,self.sji_info[i].poffysji
    ptr_free,self.sji_info[i].pofffsji
;
    ...
    ptr_free,self.sjiobs_info[i].pdtmpsji
  endfor
  return
end

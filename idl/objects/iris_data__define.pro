...
;
; $Id: iris_data__define.pro,v 1.116 2020/08/27 19:29:11 mawiesma Exp $
;
;-
...
; called by obj_destroy, frees all pointers and closes all associated files
  ...
  for i=0,self.nfiles-1 do begin
    ...
    ptr_free,self.aux_info[i].pc1_1
    ptr_free,self.aux_info[i].pc1_2
    ptr_free,self.aux_info[i].pc2_1
    ptr_free,self.aux_info[i].pc2_2
    ptr_free,self.aux_info[i].pc3_1
    ptr_free,self.aux_info[i].pc3_2
    ptr_free,self.aux_info[i].pc3_3
    ptr_free,self.aux_info[i].pc2_3
    ptr_free,self.aux_info[i].it01pfuv
    ptr_free,self.aux_info[i].it01pnuv
    ptr_free,self.aux_info[i].it06tfuv
    ptr_free,self.aux_info[i].it06tnuv
    ptr_free,self.aux_info[i].it14sfuv
    ptr_free,self.aux_info[i].it14snuv
    ptr_free,self.aux_info[i].it15sfuv
    ptr_free,self.aux_info[i].it15snuv
    ptr_free,self.aux_info[i].it16sfuv
    ptr_free,self.aux_info[i].it16snuv
    ptr_free,self.aux_info[i].it17sfuv
    ptr_free,self.aux_info[i].it17snuv
    ptr_free,self.aux_info[i].it18sfuv
    ptr_free,self.aux_info[i].it18snuv
    ptr_free,self.aux_info[i].it19sfuv
    ptr_free,self.aux_info[i].it19snuv
    ptr_free,self.aux_info[i].poffxfuv
    ptr_free,self.aux_info[i].poffxnuv
    ptr_free,self.aux_info[i].poffyfuv
    ptr_free,self.aux_info[i].poffynuv
    ptr_free,self.aux_info[i].poffffuv
    ptr_free,self.aux_info[i].pofffnuv
;
    ...
    ptr_free,self.obs_info[i].pdtmfuv
    ptr_free,self.obs_info[i].pdtmnuv
  endfor
  if self.lu ge 100 and self.lu le 128 then free_lun,self.lu
  return
end
...
;returns auxiliary information about raster in a structure
  ...
  aux_inf={time:*(self.aux_info[ifile].time), $
           ...
           pc1_1:*(self.aux_info[ifile].pc1_1), $
           pc1_2:*(self.aux_info[ifile].pc1_2), $
           pc2_1:*(self.aux_info[ifile].pc2_1), $
           pc2_2:*(self.aux_info[ifile].pc2_2), $
           pc3_1:*(self.aux_info[ifile].pc3_1), $
           pc3_2:*(self.aux_info[ifile].pc3_2), $
           pc3_3:*(self.aux_info[ifile].pc3_3), $
           pc2_3:*(self.aux_info[ifile].pc2_3), $
           it01pfuv:*(self.aux_info[ifile].it01pfuv), $
           it01pnuv:*(self.aux_info[ifile].it01pnuv), $
           it06tfuv:*(self.aux_info[ifile].it06tfuv), $
           it06tnuv:*(self.aux_info[ifile].it06tnuv), $
           it14sfuv:*(self.aux_info[ifile].it14sfuv), $
           it14snuv:*(self.aux_info[ifile].it14snuv), $
           it15sfuv:*(self.aux_info[ifile].it15sfuv), $
           it15snuv:*(self.aux_info[ifile].it15snuv), $
           it16sfuv:*(self.aux_info[ifile].it16sfuv), $
           it16snuv:*(self.aux_info[ifile].it16snuv), $
           it17sfuv:*(self.aux_info[ifile].it17sfuv), $
           it17snuv:*(self.aux_info[ifile].it17snuv), $
           it18sfuv:*(self.aux_info[ifile].it18sfuv), $
           it18snuv:*(self.aux_info[ifile].it18snuv), $
           it19sfuv:*(self.aux_info[ifile].it19sfuv), $
           it19snuv:*(self.aux_info[ifile].it19snuv), $
           poffxfuv:*(self.aux_info[ifile].poffxfuv), $
           poffxnuv:*(self.aux_info[ifile].poffxnuv), $
           poffyfuv:*(self.aux_info[ifile].poffyfuv), $
           poffynuv:*(self.aux_info[ifile].poffynuv), $
           poffffuv:*(self.aux_info[ifile].poffffuv), $
           pofffnuv:*(self.aux_info[ifile].pofffnuv) }
  return,aux_inf
end
...
;returns auxiliary information about SJI in a structure
  ...
  sji_inf={time:*(self.sji_info[lwin].time), $
           ...
           pc1_1:*(self.sji_info[lwin].pc1_1), $
           pc1_2:*(self.sji_info[lwin].pc1_2), $
           pc2_1:*(self.sji_info[lwin].pc2_1), $
           pc2_2:*(self.sji_info[lwin].pc2_2), $
           pc3_1:*(self.sji_info[lwin].pc3_1), $
           pc3_2:*(self.sji_info[lwin].pc3_2), $
           it01psji:*(self.sji_info[lwin].it01psji), $
           it06tsji:*(self.sji_info[lwin].it06tsji), $
           it14ssji:*(self.sji_info[lwin].it14ssji), $
           it15ssji:*(self.sji_info[lwin].it15ssji), $
           it16ssji:*(self.sji_info[lwin].it16ssji), $
           it17ssji:*(self.sji_info[lwin].it17ssji), $
           it18ssji:*(self.sji_info[lwin].it18ssji), $
           it19ssji:*(self.sji_info[lwin].it19ssji), $
           poffxsji:*(self.sji_info[lwin].poffxsji), $
           poffysji:*(self.sji_info[lwin].poffysji), $
           pofffsji:*(self.sji_info[lwin].pofffsji) }
  return,sji_inf
end
...
;returns info from auxiliary extension 2 for raster
  ...
  obs_inf={frmid:*(self.obs_info[ifile].frmid), $
           ...
           pdtmfuv:*(self.obs_info[ifile].pdtmfuv), $
           pdtmnuv:*(self.obs_info[ifile].pdtmnuv)}
  return,obs_inf
end
...
function iris_data::obs_info_sji,lwin
  ...
  obs_inf={frmid:*(self.sjiobs_info[lwin].frmid), $
           ...
           pdtmpsji:*(self.sjiobs_info[lwin].pdtmpsji)}
  return,obs_inf
end
...
;
  ...
  endelse
   self.sji_info[lwin].pc1_1=ptr_new(reform(a[fxpar(h,'PC1_1'),*]))
   self.sji_info[lwin].pc1_2=ptr_new(reform(a[fxpar(h,'PC1_2'),*]))
   self.sji_info[lwin].pc2_1=ptr_new(reform(a[fxpar(h,'PC2_1'),*]))
   self.sji_info[lwin].pc2_2=ptr_new(reform(a[fxpar(h,'PC2_2'),*]))
   self.sji_info[lwin].pc3_1=ptr_new(reform(a[fxpar(h,'PC3_1'),*]))
   self.sji_info[lwin].pc3_2=ptr_new(reform(a[fxpar(h,'PC3_2'),*]))
   self.sji_info[lwin].it01psji=ptr_new(reform(a[fxpar(h,'IT01PSJI'),*]))
   self.sji_info[lwin].it06tsji=ptr_new(reform(a[fxpar(h,'IT06TSJI'),*]))
   self.sji_info[lwin].it14ssji=ptr_new(reform(a[fxpar(h,'IT14SSJI'),*]))
   self.sji_info[lwin].it15ssji=ptr_new(reform(a[fxpar(h,'IT15SSJI'),*]))
   self.sji_info[lwin].it16ssji=ptr_new(reform(a[fxpar(h,'IT16SSJI'),*]))
   self.sji_info[lwin].it17ssji=ptr_new(reform(a[fxpar(h,'IT17SSJI'),*]))
   self.sji_info[lwin].it18ssji=ptr_new(reform(a[fxpar(h,'IT18SSJI'),*]))
   self.sji_info[lwin].it19ssji=ptr_new(reform(a[fxpar(h,'IT19SSJI'),*]))
   self.sji_info[lwin].poffxsji=ptr_new(reform(a[fxpar(h,'POFFXSJI'),*]))
   self.sji_info[lwin].poffysji=ptr_new(reform(a[fxpar(h,'POFFYSJI'),*]))
   self.sji_info[lwin].pofffsji=ptr_new(reform(a[fxpar(h,'POFFFSJI'),*]))
;
  ...
  srow=fxpar(h,'PDTMPSJI')
  erow=fxpar(h,'LPDTMPSJI')+srow-1
  if(erow ge srow) then self.sjiobs_info[lwin].pdtmpsji = $
    ptr_new(string(a[srow:erow,*])) else self.sjiobs_info[lwin].pdtmpsji=ptr_new(' ')
;
...
; read auxilary data contained in last two extensions of each file
   ...
   self.aux_info[ifile].pc1_1=ptr_new(reform(d[fxpar(hdr,'PC1_1'),*]))
   self.aux_info[ifile].pc1_2=ptr_new(reform(d[fxpar(hdr,'PC1_2'),*]))
   self.aux_info[ifile].pc2_1=ptr_new(reform(d[fxpar(hdr,'PC2_1'),*]))
   self.aux_info[ifile].pc2_2=ptr_new(reform(d[fxpar(hdr,'PC2_2'),*]))
   self.aux_info[ifile].pc3_1=ptr_new(reform(d[fxpar(hdr,'PC3_1'),*]))
   self.aux_info[ifile].pc3_2=ptr_new(reform(d[fxpar(hdr,'PC3_2'),*]))
   self.aux_info[ifile].pc3_3=ptr_new(reform(d[fxpar(hdr,'PC3_3'),*]))
   self.aux_info[ifile].pc2_3=ptr_new(reform(d[fxpar(hdr,'PC2_3'),*]))
   self.aux_info[ifile].it01pfuv=ptr_new(reform(d[fxpar(hdr,'IT01PFUV'),*]))
   self.aux_info[ifile].it01pnuv=ptr_new(reform(d[fxpar(hdr,'IT01PNUV'),*]))
   self.aux_info[ifile].it06tfuv=ptr_new(reform(d[fxpar(hdr,'IT06TFUV'),*]))
   self.aux_info[ifile].it06tnuv=ptr_new(reform(d[fxpar(hdr,'IT06TNUV'),*]))
   self.aux_info[ifile].it14sfuv=ptr_new(reform(d[fxpar(hdr,'IT14SFUV'),*]))
   self.aux_info[ifile].it14snuv=ptr_new(reform(d[fxpar(hdr,'IT14SNUV'),*]))
   self.aux_info[ifile].it15sfuv=ptr_new(reform(d[fxpar(hdr,'IT15SFUV'),*]))
   self.aux_info[ifile].it15snuv=ptr_new(reform(d[fxpar(hdr,'IT15SNUV'),*]))
   self.aux_info[ifile].it16sfuv=ptr_new(reform(d[fxpar(hdr,'IT16SFUV'),*]))
   self.aux_info[ifile].it16snuv=ptr_new(reform(d[fxpar(hdr,'IT16SNUV'),*]))
   self.aux_info[ifile].it17sfuv=ptr_new(reform(d[fxpar(hdr,'IT17SFUV'),*]))
   self.aux_info[ifile].it17snuv=ptr_new(reform(d[fxpar(hdr,'IT17SNUV'),*]))
   self.aux_info[ifile].it18sfuv=ptr_new(reform(d[fxpar(hdr,'IT18SFUV'),*]))
   self.aux_info[ifile].it18snuv=ptr_new(reform(d[fxpar(hdr,'IT18SNUV'),*]))
   self.aux_info[ifile].it19sfuv=ptr_new(reform(d[fxpar(hdr,'IT19SFUV'),*]))
   self.aux_info[ifile].it19snuv=ptr_new(reform(d[fxpar(hdr,'IT19SNUV'),*]))
   self.aux_info[ifile].poffxfuv=ptr_new(reform(d[fxpar(hdr,'POFFXFUV'),*]))
   self.aux_info[ifile].poffxnuv=ptr_new(reform(d[fxpar(hdr,'POFFXNUV'),*]))
   self.aux_info[ifile].poffyfuv=ptr_new(reform(d[fxpar(hdr,'POFFYFUV'),*]))
   self.aux_info[ifile].poffynuv=ptr_new(reform(d[fxpar(hdr,'POFFYNUV'),*]))
   self.aux_info[ifile].poffffuv=ptr_new(reform(d[fxpar(hdr,'POFFFFUV'),*]))
   self.aux_info[ifile].pofffnuv=ptr_new(reform(d[fxpar(hdr,'POFFFNUV'),*]))
; frmid, fdbid, crsid, etc in exten_no=uwin+2
   ...
   srow=fxpar(hdr,'PDTMFUV')
   erow=fxpar(hdr,'LPDTMFUV')+srow-1
   if(erow ge srow) then self.obs_info[ifile].filen=ptr_new(string(d[srow:erow,*])) else self.obs_info[ifile].filen=ptr_new(' ')
   srow=fxpar(hdr,'PDTMNUV')
   erow=fxpar(hdr,'LPDTMNUV')+srow-1
   if(erow ge srow) then self.obs_info[ifile].filen=ptr_new(string(d[srow:erow,*])) else self.obs_info[ifile].filen=ptr_new(' ')
end
...
auxinf=create_struct(name='aux_info','time',ptr_new(), $
                                     ...
                                     'pc1_1',ptr_new(),'pc1_2',ptr_new(), $
                                     'pc2_1',ptr_new(),'pc2_2',ptr_new(), $
                                     'pc3_1',ptr_new(),'pc3_2',ptr_new(), $
                                     'pc3_3',ptr_new(),'pc2_3',ptr_new(), $
                                     'it01pfuv',ptr_new(),'it01pnuv',ptr_new(), $
                                     'it06tfuv',ptr_new(),'it06tnuv',ptr_new(), $
                                     'it14sfuv',ptr_new(),'it14snuv',ptr_new(), $
                                     'it15sfuv',ptr_new(),'it15snuv',ptr_new(), $
                                     'it16sfuv',ptr_new(),'it16snuv',ptr_new(), $
                                     'it17sfuv',ptr_new(),'it17snuv',ptr_new(), $
                                     'it18sfuv',ptr_new(),'it18snuv',ptr_new(), $
                                     'it19sfuv',ptr_new(),'it19snuv',ptr_new(), $
                                     'poffxfuv',ptr_new(),'poffxnuv',ptr_new(), $
                                     'poffyfuv',ptr_new(),'poffynuv',ptr_new(), $
                                     'poffffuv',ptr_new(),'pofffnuv',ptr_new())
sjiinf=create_struct(name='sji_info','xs',0,'xw',0,'ys',0,'yw',0,'time',ptr_new(), $
                                     ...
                                     'pc2_1',ptr_new(),'pc2_2',ptr_new(), $
                                     'pc3_1',ptr_new(),'pc3_2',ptr_new(), $
                                     'it01psji',ptr_new(),'it06tsji',ptr_new(), $
                                     'it14ssji',ptr_new(),'it15ssji',ptr_new(), $
                                     'it16ssji',ptr_new(),'it17ssji',ptr_new(), $
                                     'it18ssji',ptr_new(),'it19ssji',ptr_new(), $
                                     'poffxsji',ptr_new(),'poffysji',ptr_new(), $
                                     'pofffsji',ptr_new())
